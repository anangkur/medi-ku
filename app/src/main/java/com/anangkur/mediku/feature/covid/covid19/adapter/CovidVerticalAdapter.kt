...
class CovidVerticalAdapter: BaseAdapter<NewCovid19Summary>() {

    override val layout: Int
        get() = R.layout.item_covid
    ...
    override fun bind(data: NewCovid19Summary, itemView: View, position: Int) {
        ...
        if (data.newConfirmed?:0 > 0){
            itemView.tv_confirmed.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_arrow_drop_up_red, 0, 0, 0)
        ...
        if (data.newDeaths?:0 > 0){
            itemView.tv_death.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_arrow_drop_up_red, 0, 0, 0)
        ...
        if (data.newRecovered?:0 > 0){
            itemView.tv_recovered.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_arrow_drop_up_green, 0, 0, 0)
