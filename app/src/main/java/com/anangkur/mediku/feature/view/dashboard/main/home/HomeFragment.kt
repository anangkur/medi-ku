...
import com.anangkur.mediku.feature.view.dashboard.main.home.adapter.NewsAdapter
import com.anangkur.mediku.feature.view.medicalRecords.listMedicalRecords.MedicalRecordsActivity
import com.anangkur.mediku.feature.view.mens.menstrual.MenstrualActivity
import com.anangkur.mediku.feature.view.originalNews.OriginalNewsActivity
...
class HomeFragment: BaseFragment<FragmentHomeBinding, HomeViewModel>(), HomeActionListener {
                ...
                when (it.status){
                    ...
                    BaseResult.Status.SUCCESS -> {
                        ...
                        if (it.data.isNullOrEmpty()){
                            ...
                            setupShowLatestNews(it.data.map { data -> mapper.mapToIntent(data) })
                        }
                    }
    ...
    private fun setupShowLatestNews(data: List<ArticleIntent>){
    ...
    override fun onClickNews(data: ArticleIntent) {
